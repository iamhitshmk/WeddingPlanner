...
public class VendorListDetailsViewModel extends ViewModel {
    ...
    LiveData<ArrayList<VendorListDetailItem>> getWeddingCardsData(){
        listDetailItems.clear();
        listDetailItems.add(new VendorListDetailItem(R.drawable.ic_wedding_cards_one,"AA Enterprises","4","4.2","Matchiswala Compound Santacruz West","20000","AA Enterprises are a specialized Boxed Wedding Invitation Designer experts. They claim, \"With our Specialization in this field from the past 40 years, we bring together the best in class artwork in fancy and designer boxes and photo frames. You get numerous designs of frames to choose from with the best craftsmanship and guarantee of longevity."));
        listDetailItems.add(new VendorListDetailItem(R.drawable.ic_wedding_cards_two,"Flying Elephant Designs","2","4.4","Eastern Express Highway, Sion East 400022 Sion (Mumbai) ","30000","Flying Elephant Designs is an invitation card company located in Sion East which is situated in Central Mumbai. The first thing to see at a wedding is the invitation card, and thus it needs to be perfect in every way and should give a glimpse of your wedding. It is the first thing that reaches out to your guest and hence, you would definitely want a design that you like and your guests appreciate. If you are looking for one such company that can design such invitation cards for you, then Flying Elephant Designs is the one-stop shop for you. It offers a range of user-friendly card solutions to provide you with an invitation card that you will treasure forever.\n" +
                "\n" +
                "Designs Offered\n" +
                "\n" +
    ...
    LiveData<ArrayList<VendorListDetailItem>> getWeddingCateringData(){
        ...
        listDetailItems.add(new VendorListDetailItem(R.drawable.ic_wedding_catering_three,"Khasiyat","4","4.1","10th Road, Chembur East, Mumbai - 400071","200000","Khasiyat Catering Services in Mumbai. Caterers with Address, Contact Number, Photos, Maps. View Khasiyat Catering Services, Mumbai on Justdial.\n" +
                "\n" +
    ...
    LiveData<ArrayList<VendorListDetailItem>> getWeddingDecoratorsData(){
        ...
        listDetailItems.add(new VendorListDetailItem(R.drawable.ic_wedding_decorators_four,"The Wedding Soul","4","4.5","400064 Kurla (Mumbai)","300000","Planning and executing a wedding is a huge task. If you are looking for a good wedding planning company to plan your wedding functions then The Wedding Soul is the choice that you should make. It is a wedding planning agency based in Mumbai which provides one-stop solutions for all your wedding needs. they will ensure to make your wedding grand and eventful.\n" +
                "\n" +
                "Services Offered\n" +
                "\n" +
    ...
    LiveData<ArrayList<VendorListDetailItem>> getWeddingDJData(){
        listDetailItems.clear();
        listDetailItems.add(new VendorListDetailItem(R.drawable.ic_wedding_dj_one,"Dj Blast Audio Sound","4","4.6","Sane Guru Ji Marg, Mahalaxmi 400013 Mahalaxmi (Mumbai)","5000","\n" +
    ...
    LiveData<ArrayList<VendorListDetailItem>> getWeddingPhotographersData(){
        listDetailItems.clear();
        listDetailItems.add(new VendorListDetailItem(R.drawable.ic_wedding_photographers_one,"Blu Swan Media","4","4.9"," M. G. ROAD, BORIVALI EAST Mumbai","20000","->BLU SWAN MEDIA is a community based professional photography business given to quality portraiture and full wedding coverage. Blu swan media seeks to provide a service to individuals, couples, and families that emphasizes and enhances the quality of their relationships through photographic imaging."+"\n"+"Services & Pricing\n" +
                "Candid Photography\n" +
                "₹ 20,000 per day\n" ));
        listDetailItems.add(new VendorListDetailItem(R.drawable.ic_wedding_photographers_two,"Divyesh Harchekar Photography","4","2","Mumbai","100000","Divyesh Harchekar Photography since 2015 based in Mumbai & have covered more than 50 weddings till now. We are a Team of young Professionals to memorize your moments. It’s a complete package every bride and groom look for in wedding photography. We owe to our clients to deliver the best of our experience talent & wisdom. It’s a complete package every bride and groom looks for in wedding photography."+"\n"+"Services & Pricing\n" +"35,000 per day\n" +

                "1,00,000 per day\n" +
                "Photo + Video"));

        listDetailItems.add(new VendorListDetailItem(R.drawable.ic_wedding_photographers_three,"Fantasy Filmer","4","4.2","Malad WEST,Mumbai","100000","Fantasy Filmer is a wonderful photography company based in Dwarka, West Delhi. It is a one-stop solution for all your requirements to get your wedding pictures clicked. While planning a wedding, it is necessary to choose a good photography company as they are the ones who transform our joyful moments into memories for you to take a trip down the memory lane. With its inception in the year 2014, Fantasy Filmer has been covering weddings fantastically and will ensure to cover each of your precious moments in the best way possible.\n" +
                "\n" +
                "Services Offered\n" +
                "\n" +
    ...
    LiveData<ArrayList<VendorListDetailItem>> getWeddingVenuesData(){
        listDetailItems.clear();
        listDetailItems.add(new VendorListDetailItem(R.drawable.ic_wedding_venue_one,"Kiaraa Banquet hall","4","4.2","Road No 16 Z, Thane West, Thane - 400604","10000","\n" +
        ...
        listDetailItems.add(new VendorListDetailItem(R.drawable.ic_wedding_venue_two," Lavender Bough","4","4.8"," 90 Feet Road, Ghatkopar East, Mumbai - 400077","20000","Lavender Bough in Ghatkopar, Mumbai\n" +
        ...
        listDetailItems.add(new VendorListDetailItem(R.drawable.ic_wedding_venue_three,"Pracharya B N Vaidya Sabhagriha","4","4.3","Sir Bhalchandra Road, Dadar East, Mumbai - 400014","15000","\n" +
        ...
        listDetailItems.add(new VendorListDetailItem(R.drawable.ic_wedding_venue_four," Rangsharda Auditorium","4","4.0","Bandra Reclamation-bandra West, Mumbai - 400050","10000","\n" +
    ...
    LiveData<ArrayList<VendorListDetailItem>> getWeddingMakeupData(){
        listDetailItems.clear();
        listDetailItems.add(new VendorListDetailItem(R.drawable.ic_wedding_makeup_one,"Bridal Makeup Artist Kriti B","4","4.2","Near CIDCO Exhibition Centre 400703 Vashi","1400",""));
        listDetailItems.add(new VendorListDetailItem(R.drawable.ic_wedding_makeup_two,"Farah Charna Hair & Makeup","4","4.2","Bandra 400050 Kurla (Mumbai)","5000","Services Offered\n" + "\n" +"Farah Charna is a person, who is skilful and experienced enough to\n" +
        ...
        listDetailItems.add(new VendorListDetailItem(R.drawable.ic_wedding_makeup_three,"Glamup by Sonali","4","4.0","vile parle 400057 Vile Parle East (Mumbai)","7000","Services Offered\n" + "\n" +
        ...
        listDetailItems.add(new VendorListDetailItem(R.drawable.ic_wedding_makeup_four,"Hiya Makeup Studio","4","4.5","BR Road, Vaishali Naga 400080 Mulund West (Mumbai)","1000","Services Offered\n" +
                "\n" +
                ...
                "->Draping\n" +
                "->Nails"));
        listDetailItems.add(new VendorListDetailItem(R.drawable.ic_wedding_makeup_five,"Image Maker Makeup & Hair Academy","3","3.9","Andheri east 400001 Marol, Andheri East (Mumbai)","3000","Services offered\n" +
                "\n" +
                ...
                "Jewellery styling"));
        listDetailItems.add(new VendorListDetailItem(R.drawable.ic_wedding_makeup_six,"Namita Makeover","4","3.9","Owale, Thane West (Mumbai)","2000","Services Offered\n" + "\n" +"Navita Makeover will be with you every step of the way and you will be\n" +
